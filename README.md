# P2P Exchange — Full Stack Web3 Application

A production-ready P2P crypto exchange platform built with Next.js 16, React 19, Tailwind CSS v4, Privy, Thirdweb, and PostgreSQL.
